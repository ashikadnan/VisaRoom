...
namespace VisaRoom.Migrations
{
    ...
    [Migration("20231207150802_qande")]
    partial class qande
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VisaRoom.Models.Experience", b =>
                {
                    b.HasOne("VisaRoom.Models.Candidate", null)
                        .WithOne("Experience")
                        .HasForeignKey("VisaRoom.Models.Experience", "CandidateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("VisaRoom.Models.Qualification", b =>
                {
                    b.HasOne("VisaRoom.Models.Candidate", "Candidate")
                        ...
                        .HasForeignKey("VisaRoom.Models.Qualification", "CandidateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
